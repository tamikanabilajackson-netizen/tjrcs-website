          ...
          <div className="flex items-center justify-center gap-10">
            ...
            >
              <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                ...
                <path d="M9.09 8.06c.17-.4.68-.42.9-.05l.72 1.24c.13.22.11.5-.05.7l-.55.69a6.1 6.1 0 0 0 2.9 2.9l.69-.55c.2-.16.48-.18.7-.05l1.24.72c.37.22.35.73-.05.9-.6.26-1.28.32-1.92.14a7.6 7.6 0 0 1-4.72-4.72 2.9 2.9 0 0 1 .14-1.92z" fill="currentColor" stroke="none"/>
              </svg>
            </a>
